...
public class DocumentAddText {
	...
	private String addDocument(String documentId, String title, String content, String language) throws ClientProtocolException, URISyntaxException, IOException {
		// Check secutiryToken
